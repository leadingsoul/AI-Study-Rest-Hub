      ...
      <div class="quick-actions">
        ...
        -->
          <div class="action-card" @click="goToVideos">
            ...
            <h3>视频百科</h3>
            <p>技术点讲解视频，分类学习，休闲娱乐</p>
          </div>
          <div class="action-card" @click="goToAiGuess">
            <el-icon class="card-icon flag-icon"><Flag /></el-icon>
            <h3>AI猜词游戏</h3>
            <p>AI互动游戏，提升学习趣味性</p>
          </div>
        </div>
  ...
  try {
    ...
    noticeList.value = [
      ...
      },
      {
        ...
        type: 'FEATURE',
        createTime: '2025-12-23 15:30:00',
        isActive: true
      },
      {
        id: 3,
