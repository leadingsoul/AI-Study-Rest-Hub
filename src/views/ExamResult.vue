      ...
      <div class="result-header">
        <div class="header-left">
          ...
          <div class="exam-info">
            ...
            <p v-if="examRecord.userName"><strong>👤 考生姓名：</strong>{{ examRecord.userName }}</p>
...
const downloadResult = async () => {
  try {
    ...
    link.download = `考试成绩单_${examRecord.value.userName}_${new Date().toLocaleDateString()}.png`
